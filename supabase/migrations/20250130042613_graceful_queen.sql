/*
  # Fix Contact Relations Schema
  
  1. Changes
    - Add property_contact_relations table
    - Update references from property_contacts to profiles
...
-- Create property_contact_relations table
